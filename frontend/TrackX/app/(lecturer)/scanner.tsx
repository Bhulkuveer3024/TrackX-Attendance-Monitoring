...
export default function ScannerScreen() {
  ...
  const handleBarCodeScanned = async ({ data }) => {
    ...
    try {
      // Capture photo — optional, does not block check-in
      let photoData = null;
      try {
        ...
        console.log("Photo capture failed:", photoError.message);
      }
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.overlay}>
          ...
          <Text style={styles.scanText}>Point camera at student's QR code</Text>
        </View>
